...
/** WORK IN PROGRESS
 *purpose: a popup window to get employee details.
 * @author franzielle
 */
/*
   ...
   private JTextField[] fields;
    ...
    private void handleSave() {
        try {
            ...
            // Logic to instantiate the correct subclass
            ...
            JOptionPane.showMessageDialog(this, "Error: Basic Salary, Allowances, and Hourly Rate must be numbers.", 
    ...
    private void fillExistingData(Employee emp) {
        fields[0].setText(emp.getEmpNum());
        fields[1].setText(emp.getLastName());
        fields[2].setText(emp.getFirstName());
        fields[3].setText(emp.getBirthDate());
        fields[4].setText(emp.getSssNumber());
        fields[5].setText(emp.getPhilhealthNumber());
        fields[6].setText(emp.getTin());
        fields[7].setText(emp.getPagibigNumber());
